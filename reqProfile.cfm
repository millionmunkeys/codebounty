...
<form name="userProfile" id="userProfile" method="post" action="/profile.cfm?">
		...
		<div style="float:left; width: 48%; margin: auto;">
			<img src="https://fbcdn-profile-a.akamaihd.net/hprofile-ak-ash4/369549_1235407201_572798347_q.jpg" width="64"><br>
			<input style="width:200px" name="User.name.1" type="text" value="Almas Kebekbayev"> <label for="User.name"> : Name</label><br>
			<input style="width:200px" name="User.email.1" type="text" value="almasi77@gmail.com"> <label for="User.email"> : Email</label><br>
		</div>	
		<div style="float:right; width: 48%; margin: auto; text-align: right;">
			...
			<label for="LinkedIn">LinkedIn : </label>http:// <input id="LinkedIn" name="LinkedIn.1" type="text" value="http://www.linkedin.com/pub/matthew-chase-whittemore/13/446/2b7"> <br>
			<label for="GetHub">GitHub : </label>http:// <input id="GetHub" name="GetHub.1" type="text" value=""> <br>
			<label for="Twitter">Twitter : </label>http:// <input id="Twitter" name="Twitter.1" type="text" value="www.twitter.com/kebek_a"> <br>
	...
	<fieldset>
		...
		<div>
			...
			<div class="viewButton ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-default" role="button" aria-disabled="false"><span class="ui-button-text">
				<span class="ui-button-text">
					<a id="finishButton" onclick="JAVASCRIPT:next();">Download</a>
				</span>
			</span></div>

			<div class="viewButton ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false"><span class="ui-button-text">
				<span class="ui-button-text">
					<a id="" onclick="JAVASCRIPT:false;">Protest</a>
				</span>
			</span></div>
...
Unfortunately, the company who created the plugin is no longer in business and we have not been able to get in touch with anyone willing to upgrade our plug in. In short, we need the ability to capture our customer's email address and then view them in relationship to the associated survey data.</span> </div>
		...
		<div class="projectData">
			...
			<div class="productLogo">
				<input type="hidden" name="Product.logo.1" value="http://angelhack.millionmunkeys.net/images/platforms/platforms_r2_c2.gif"> <img src="http://angelhack.millionmunkeys.net/images/platforms/platforms_r2_c2.gif"> 
			</div>
		</div>
	</div>
...
function next(){
	window.open("https://www.github.com/mcwhittemore/angel-hack-test/archive/master.zip");
	$("#finishButton").html("Accept").attr('onclick', 'JAVASCRIPT:accept();');
}

function accept(){
	var html = $("#removethis").html();
	html = "<div class='ui-state-error'>Thanks for using Code Bounty.</div><br><br>"+html;
	$("#removethis").html(html);
	$("#finishButton").html("Accepted").attr('onclick', 'JAVASCRIPT:false;');
}
